...
const DesktopNavBar = ({setIsOpen}: NavBarProps): JSX.Element => 
...
const MobileNavBar = ({isOpen, setIsOpen}: MobileNavBarProps): JSX.Element =>
...
export const NavBarLinks = ({onClick}: NavBarLinksProps): JSX.Element =>
    <nav>
        <ul>
            <Link to={"/"}>
                <li onClick={onClick}>
...
export const Logo = ({setIsOpen}: NavBarProps): JSX.Element => 
