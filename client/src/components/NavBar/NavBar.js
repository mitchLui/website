...
export const NavBarLinks = ({onClick}) =>
    <nav>
        <ul>
            <Link to={"/"}><li onClick={onClick}>Home</li></Link>
            <Link to={"/projects"}><li onClick={onClick}>Projects</li></Link>
            <Link to={"/cv.pdf"} target={"_blank"} rel={"noreferrer"}><li onClick={onClick}>CV</li></Link>
        </ul>
    </nav>
