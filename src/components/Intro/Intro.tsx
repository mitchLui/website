...
export const Intro = (): React.ReactElement =>
    <div className={'intro'}>
        ...
        <div className={'item'}>
        Born and raised in Hong Kong, I am now based in London as a Graduate Software Engineer at <CompanyLink className={'link wise'} url="https://www.wise.com" text={'Wise\'s'} /> Spend Business Team to create the one account for businesses to thrive everywhere.
